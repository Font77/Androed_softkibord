...
public class lAtinkibord extends Keyboard {
    ...
    public lAtinkibord(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
    }
    public lAtinkibord(Context context, int layoutTemplateResId,
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
        ...
        } else if (key.codes[0] == lAtinkibordviyu.KEYCODE_LANGUAGE_SWITCH) {
